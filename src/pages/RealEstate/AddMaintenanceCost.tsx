...
export default function AddMaintenanceCost() {
  const { id } = useParams()
  ...
  return (
    <div className="min-h-screen bg-gray-50" dir="rtl">
      <div className="bg-gray-900 text-white px-4 py-5 flex items-center gap-3 sticky top-0 z-10">
        ...
        <h1 className="text-lg font-bold flex-1">إضافة تكلفة صيانة</h1>
        <button
      ...
      <div className="p-4 space-y-4 max-w-lg mx-auto">
        ...
        <div className="bg-white rounded-2xl p-4 border border-gray-100 shadow-sm">
          <label className="block text-xs text-gray-400 mb-1.5 font-medium">الفئة</label>
